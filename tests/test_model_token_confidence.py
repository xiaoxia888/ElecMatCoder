...
class ModelTokenConfidenceTest(unittest.TestCase):
    ...
    def test_field_score_uses_joint_value_probability_not_json_keys(self):
        structured = {
        ...
        self.assertAlmostEqual(scores["TYPE"]["confidence"], 0.8 ** 6, places=6)
    ...
    def test_type_confidence_includes_category_decision(self):
        ...
        self.assertAlmostEqual(scores["CATEGORY"]["confidence"], 0.6 * 0.9, places=6)
        self.assertAlmostEqual(scores["TYPE"]["confidence"], 0.6 * 0.9 * 0.8 * 0.7, places=6)
